...
VERSION=
commit=false
url=https://github.com/ioncoincore/ion
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the ion, gitian-builder, gitian.sigs, and ion-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/ioncoincore/ion
